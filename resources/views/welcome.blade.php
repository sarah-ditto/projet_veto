...
<div class="rounded m-auto p-3 " id="form">
  ...
  <div class="d-flex justify-content-center">
    <form class="form-inline" method="POST" action="{{route('zipSearchResult')}}">
      ...
      <div>
        <input type="text" id="codePostal" name="codePostal" placeholder="Code postal" value="{{old('codePostal')}}" aria-describedby="codePostal_feedback" class="form-control @error('codePostal') is-invalid @enderror">
  ...
  <h5 class="text-center mt-3">Recherche par nom d'un professionnel</h4>
    <div class="d-flex justify-content-center">
      <form class="form-inline" method="POST" action="{{route('nameSearchResult')}}">
        ...
        <div>
          <input type="text" id="nom" name="nom" placeholder="Nom" value="{{old('nom')}}" aria-describedby="nom_feedback" class="form-control @error('nom') is-invalid @enderror">
          <button type="submit" class="btn btn-outline-info">Rechercher</button>
          @error('nom')
